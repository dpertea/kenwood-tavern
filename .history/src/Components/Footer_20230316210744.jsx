    ...
    <div id="footerWrapper">
      ...
      <div id="signupWrapper">
        <div
          ...
          style={{ textAlign: "left", boxSizing: "border-box", width: "40%" }}
        >
          <label for="enterEmail" id="signupLabel">
            Email:
          </label>
          <br />
          <input
        ...
        <button id="subscribeButton" style={{ display: "inline-block" }}>
          SUBSCRIBE
        </button>
      </div>
